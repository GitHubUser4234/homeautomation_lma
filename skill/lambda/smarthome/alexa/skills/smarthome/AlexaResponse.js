...
class AlexaResponse {
    ...
    constructor(opts) {
        ...
        if (opts.event !== undefined)
            ...
            "header": {
                ...
                "messageId": this.checkValue(opts.messageId, AWS.util.uuid.v4()),
    ...
    createPayloadEndpointCapability(opts) {
		...
		let instance = this.checkValue(opts.instance, false);
		if (instance) {
        ...
        if (actionMappings) {
            ...
            capability['semantics']['actionMappings'] = actionMappings;
			capability['semantics']['stateMappings'] = this.checkValue(opts.stateMappings, {});
			capability['capabilityResources'] = {};
			capability['capabilityResources']['friendlyNames'] = this.checkValue(opts.friendlyNames, {});
        }
        return capability;
    }
